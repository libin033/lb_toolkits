...
class DataCollectionLANCEAMSR2 : 
    LANCEAMSR2_AU_Rain_NRT_R02_V2 = DataCollectionDefinition(
            api_id="CMR",
    ...
    LANCEAMSR2_AU_Ocean_NRT_R01_V1 = DataCollectionDefinition(
            api_id="CMR",
    ...
    LANCEAMSR2_AU_Land_NRT_R02_V2 = DataCollectionDefinition(
            api_id="CMR",
    ...
    LANCEAMSR2_AU_SI12_NRT_R04_V4 = DataCollectionDefinition(
            api_id="CMR",
    ...
    LANCEAMSR2_AU_SI25_NRT_R04_V4 = DataCollectionDefinition(
            api_id="CMR",
    ...
    LANCEAMSR2_AU_SI6_NRT_R04_V4 = DataCollectionDefinition(
            api_id="CMR",
    ...
    LANCEAMSR2_AU_DySno_NRT_R02_V2 = DataCollectionDefinition(
            api_id="CMR",
